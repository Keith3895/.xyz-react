...
export default class RaisedButton extends Component<ButtonProps> {
    ...
    render() {
        return (
            <button type='button' className="w-36 h-10 bg-custom-orange-600  justify-center items-center inline-flex cursor-pointer hover:bg-custom-orange-400 active:bg-custom-orange-700">
