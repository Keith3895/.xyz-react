...
import List from "@/components/srcC";
                ...
                <div className="w-11/12 md:w-1/2">
                    <form className="flex flex-col items-center space-y-4">
                        ...
                        <div className="relative w-full">
                            ...
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Search Blogs..." required />
